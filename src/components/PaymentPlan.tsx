...
export function PaymentPlan() {
  ...
  return (
    <>
      <section id="payment" ref={trackRef} className="py-24 lg:py-32 bg-[#0a0a0a] text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-white/10">
              <div className="flex justify-between items-center mb-6 pb-4 border-b border-white/10">
                <span className="text-white/50 text-sm uppercase tracking-wider">Milestone</span>
              ...
              <div className="space-y-3">
                {paymentMilestones.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="text-[#c9a962] text-xl font-semibold">
                      {item.percentage}
                    </span>
                  </div>
                ))}
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex justify-between items-center">
                ...
                <span className="text-[#c9a962] text-2xl font-semibold">100%</span>
              </div>
            </div>
          </div>
        </div>
